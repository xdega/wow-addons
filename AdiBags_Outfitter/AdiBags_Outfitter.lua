...
L["Outfitter item sets"] = "Outfitter Gegenstand-Sets"
L["Put items belonging to one or more sets of Outfitter in specific sections."] = "Stellt Gegenstände, die zu einem oder mehreren Ausrüster-Sets gehören, in bestimmte Abschnitte."

	elseif locale == "esMX" then

	elseif locale == "ruRU" then
L["Outfitter item sets"] = "Комплекты предметов экипировки"
L["Put items belonging to one or more sets of Outfitter in specific sections."] = "Поместите предметы, принадлежащие к одному или нескольким наборам снаряжения, в определенные секции."
